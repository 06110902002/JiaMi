...
public class HaspUsbHandler {
    ...
    /**
     * Private function used by the JNI module to obtain the device serial number.
     *
     * Note that from SDK 26 there is also android.os.Build.getSerial();
     * Note also that 'For apps targeting SDK higher than O_MR1 this field is set to UNKNOWN.'
     * (O_MR1 is API level 27).
     */
