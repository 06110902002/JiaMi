...
public class LicenseFile extends AppCompatActivity
        implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    private static final int PERMISSION_REQUEST_RW_EXTERNAL_STORAGE = 0;
        ...
        update.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (hasPermission) {
                    ...
                    text = "No permission to open SDCard to browse files!\n";
                    tv.setText(text);
                }
            }
        });
    ...
    public void collectInformation()
    {
        ...
        if (hasPermission) {
            ...
            text += "Failed !\nNo permission to write c2v file to SDCard!\n";
        }
        tv.setText(text);
    }
    ...
    private void requestStoragePermission() {
        ...
        ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_RW_EXTERNAL_STORAGE);
    }
